...
window.onload = function () {
     ...
     document.getElementById("inpSoeg").addEventListener("dblclick", soegWebservice);

    wsurl = "https://newsapi.org/v2/everything?q=news&apiKey=32ddb36add8b4e3cab2767635c6460e1"; // Søger i emner (fx sport eller education)
    kaldWebservice();
 ...
 function soegWebservice(){
    ...
    wsurl = "https://newsapi.org/v2/everything?q="+SW+"&apiKey=32ddb36add8b4e3cab2767635c6460e1"; // Søger i emner (fx sport eller education)
    kaldWebservice();
...
function udskrivData(jsondata) {
    ...
    for (var x in jsondata.articles) {
        ...
        <p class="Author">${AD.source.name}</p>
